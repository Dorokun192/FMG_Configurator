...
namespace FMG_Configurator__csharp_
{
    ...
    public partial class NetSettings : Window
    {
        ...
        private void NetSettingsWindow_Loaded(object sender, RoutedEventArgs e)
        {
            DeviceIDTextBlock.Text = Globals.devID;
            NetSettingsWindow.Title = "Network Settings - " + Globals.devID;
        } 
